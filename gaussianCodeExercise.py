...
class Gaussian():
    ...
    def read_data_file(self, file_name='testDataFiles/numbers.txt', sample=True):
    ...
    # Magic methods: Overwrite default Python methods
